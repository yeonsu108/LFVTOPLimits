                ...
                if not "data" in process: 
                    for systematic in systematics:
                        if systematic in [item for item in options.sysForSMtt if item not in options.sysForSig] \
                            and not process in smTTlist: 
                            print("SYSTEMTIC BEFORE continue 1: " , systematic)
                            continue
                        if systematic in options.sysForSig and not process in ['st_lfv']+smTTlist:
                            print("SYSTEMTIC BEFORE continue 2: " , systematic)
                            continue
