...
systematics_list_from_datacard_2016_2017 = {'Jes':'jec', 'hdamp':'hdamp', 'scaleEnvelope':'scale', 'SfIteraviveFitHfstats1':'CSVv2hfstat1', 'SfIteraviveFitHfstats2':'CSVv2hfstat2', 'SfIteraviveFitLfstats1':'CSVv2lfstat1', 'SfIteraviveFitLfstats2':'CSVv2lfstat2', 'SfIteraviveFitLf':'CSVv2lf', 'SfIteraviveFitHf':'CSVv2hf', 'SfIteraviveFitCferr1':'CSVv2cferr1', 'SfIteraviveFitCferr2':'CSVv2cferr2', 'Jer':'jer', 'SfPileup':'pu', 'SfLepton':'lepton', 'PDFEnvelope':'pdf', 'UE':'TuneCUETP'} # Additional systematics are stored in the rootfile but were not used for limit setting (they are not in the 2016 datacards). This list ensures we only store the systematics that were actually used
