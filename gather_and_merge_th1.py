...
base_output_dir = 'histos_suitable_for_limits_200101v43_2017/'
#base_output_dir = 'histos_suitable_for_limits_200101v41_2018/'
    ...
    for process in process_list:
        ...
        for coupling_string in coupling_strings:
            ...
            for th1_key in rootfile.GetListOfKeys():
                ...
                #if 'j3b2' in th1_name:
                #    th1 = rootfile.Get(th1_name)
                #    th1a = rootfile.Get(th1_name.replace('j3b2','j4b2'))
                #    th1.Add(th1a,1.0)
                #elif 'j3b3' in th1_name:
                #    th1 = rootfile.Get(th1_name)
                #    th1a = rootfile.Get(th1_name.replace('j3b3','j4b3'))
                #    th1b = rootfile.Get(th1_name.replace('j3b3','j4b4'))
                #    th1.Add(th1a,1.0)
                #    th1.Add(th1b,1.0)
                #else: continue
                ...
                if 'j3b2' in th1_name:
                    ...
                    th1a = rootfile.Get(th1_name.replace('j3b2','j3b3'))
                    th1.Add(th1a,1.0)
                elif 'j4b2' in th1_name:
                    th1 = rootfile.Get(th1_name)
                    th1a = rootfile.Get(th1_name.replace('j4b2','j4b3'))
                    th1b = rootfile.Get(th1_name.replace('j4b2','j4b4'))
                    th1.Add(th1a,1.0)
                    th1.Add(th1b,1.0)
                else: continue
